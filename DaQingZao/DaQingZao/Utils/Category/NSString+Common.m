...
-(BOOL)isValidPhoneNumber;
{
    ...
    /**
     ...
     22         */
    NSString * chinaTelecom = @"^1((33|53|7[0-9]|8[09])[0-9]|349)\\d{7}$";
...
//
//+(NSString *)makeID2ImageUrl:(NSString *)userId;//
//{
//    return [NSString stringWithFormat:@"%@/system/avatar?uid=%@",RequestUrl,userId];
//}
